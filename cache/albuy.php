        ...
        <div class="fl w100">
            <div class="fl fls">
                ...
                <ul class="fun">
                    ...
                    <li  class="selected"><a href="<?php echo INDEX ?>/index.php?mod=albuy"><img src="<?php echo TU ?>/u8_.png" />Video đã mua</a></li>
                    ...
                    <li class="logout"><a href="javascript:;"><img src="<?php echo TU ?>/u12.png" />Đăng xuất tài khoản</a></li>
                </ul>
            </div>
            <script>
                    $(function(){
            ...
            <div class="fl flr">
                <div class="pubtit">
                    <p rel="u2">Lịch sử Video đã mua</p>
                </div>
