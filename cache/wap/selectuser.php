...
<body>
    <header class="public ls">
        ...
        <ul class="topul overflow">
            ...
            <li class=""><p class="abs"></p><a href="<?php echo INDEX ?>/index.php?mod=typelist">Chủ đề lưu trữ </a></li>
            <li class=""><p class="abs"></p><a href="<?php echo INDEX ?>/index.php?mod=playlist">Chọn cách chơi</a></li>
        </ul>
        <p class="center"></p>
</header>
    <!--<div class="flex mt50">-->
    ...
    <!--        <li class=""><p class="abs"></p><a href="<?php echo INDEX ?>/index.php?mod=playlist">选择玩法</a></li>-->
    <!--    </ul>-->
    <!--</div>-->
