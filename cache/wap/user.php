...
<head>
    ...
    <title>Trung tâm thành viên</title>
    ...
    <div class="wrap users mt70">
        <div class="rel">
            ...
            <div class="u abs">
                ...
                <p class="p"><?php echo $this->vars["nick"] ?><span><img class="i2" src="../image/<?php echo $this->vars["sex"] ?>.png" /></span><span ><a class="co" href="<?php echo INDEX ?>/index.php?mod=set">Đặt biệt danh<img class="i3" src="../image/u.png" /></a></span></p>
            </div>
        </div>
        <ul class="s overflow">
            <li>
            ...
            <li>
                <div>
                    ...
                    <p class="p1 abs">Tiền</p>
                    <p class="p2 abs">Số dư:<?php echo $this->vars["diam"] ?></p>
                    <p class="p3 abs"><a href="<?php echo INDEX ?>/index.php?mod=money">số tiền nạp</a></p>
                </div>
            </li>
            <li>
                <div>
                    ...
                    <p class="p1 abs">Ví tiền</p>
                    <p class="p2 abs">Số dư:<?php echo $this->vars["money"] ?>đồng</p>
                    <p class="p3 abs"><a href="<?php echo INDEX ?>/index.php?mod=wallet">Mở ví tiền</a></p>
                </div>
            </li>
        </ul>
