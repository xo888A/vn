            ...
            <div class="content">
                <div class="frame">
                    ...
                    <div class="frmtable">
                        <form action="admin.php" method="get" class="search">
                            ...
                            <input name="keyword" value="<?php echo CW('get/keyword')==='0' ? '' : CW('get/keyword');  ?>" placeholder="Tìm kiếm vị trí quảng cáo, hỗ trợ tìm kiếm mờ" />
                ...
                <div class="frame">
                    ...
                    <table class="w100 list">
                        <tr>
                            <th>Sở hữu người dùng</th>
                            <th>Quảng cáo hình ảnh</th>
                            <th>Vị trí quảng cáo</th>
                            <th>Hiệu quả nhấp chuột của quảng cáo</th>
