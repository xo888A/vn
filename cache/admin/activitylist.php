    ...
    <div class="wrap">
        <div class="w100">
            ...
            <div class="content">
                <div class="frame">
                    ...
                    <div class="frmtable">
                        <form action="admin.php" method="get" class="search">
                            ...
                            <input name="keyword" value="<?php echo CW('get/keyword')==='0' ? '' : CW('get/keyword');  ?>" placeholder="Tìm kiếm tiêu đề hoạt động, hỗ trợ tìm kiếm mờ" />
                ...
                <div class="frame">
                    <p class="title">Quản lý hoạt động</p>
                    <div class="frmtable">
                    <table class="w100 list">
                        <tr>
                            <th>Tiêu đề hoạt động</th>
                            <th>Ảnh bìa hoạt động</th>
