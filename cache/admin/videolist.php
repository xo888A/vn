    ...
    <div class="wrap">
        <div class="w100">
            ...
            <div class="content">
                ...
                <div class="frame">
                    <p class="title">Quản lý video</p>
                    <div class="frmtable">
                    <table class="w100 list">
                        <tr>
                            <th><span style="color:#3FCF7F;cursor: pointer;" onclick="converSelectAll()">Chọn tất</span>/<span class='ishow' rel='post' style="color:red;cursor: pointer;">审核</span></th>
                            <th>ID Phim</th>
                            <th>Ảnh nền</th>
                            <th>Tiêu đề</th>
