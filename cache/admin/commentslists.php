            ...
            <div class="content">
                ...
                <div class="frame">
                    ...
                    <table class="w100 list">
                        <tr>
                            <th><span style="color:#3FCF7F;cursor: pointer;" onclick="converSelectAll()">Chọn tất cả</span>/<span class='ishows' rel='comments' style="color:red;cursor: pointer;">Kiểm tra</span></th>
                            <th>Trả lời người dùng</th>
                            <th>Người dùng đã phản hồi</th>
