    ...
    <div class="wrap">
        <div class="w100">
            ...
            <div class="content">
                ...
                <div class="frame">
                    <p class="title">Quản lý cộng đồng</p>
                    <div class="frmtable">
                    <table class="w100 list">
                        <tr>
                            <th><span style="color:#3FCF7F;cursor: pointer;" onclick="converSelectAll()">Chọn toàn bộ</span>/<span class='ishow' rel='post' style="color:red;cursor: pointer;">Kiểm tra</span></th>
                            <th>ID cộng đồng</th>
                            <th>Chủ đề</th>
                            <th>Lượng đọc</th>
