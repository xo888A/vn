    ...
    <div class="wrap">
        ...
        <div class="flex">
                <ul class=" margin ranksoll">
                    ...
                    <li class="selected"><p class="abs"></p><a href="<?php echo INDEX ?>/index.php?mod=typelist">Lưu trữ chủ đề</a></li>
                    <li class=""><p class="abs"></p><a href="<?php echo INDEX ?>/index.php?mod=playlist">Chọn cách chơi</a></li>                </ul>
            </div>
        </div>
