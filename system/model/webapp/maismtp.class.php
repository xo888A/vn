...
class MaiSmtp {
    ...
    // Thêm người nhận, methodtham số：to=Người nhận，cc=cc，bc=bc
    ...
    // Chuyển danh sách người nhận đến máy chủ
    ...
    // Thêm tệp đính kèm, $ stop là giá trị boolean, nếu đúng nghĩa là ngừng gửi email nếu không tìm thấy tệp đính kèm
