            ...
            foreach ($comments2 as $comment2){
               ...
               ///////////////////////
                $addcomment .= "<li>
                                    ...
                                    <div class='fl sh'>
                                        <p class='tt'>{$n1}{$addlevel1}<span>Phản hồi</span>{$n2}{$_addlevel1}<a href='javascript:;' class='fr hfnow' postid='{$id}' tel1='{$us}' nickname='{$tel1[0]['nickname']}' tel2='{$comment2['tel1']}' commentid='{$comment['id']}'>Phản hồi</a></p>
       ...
       /////////////////////
        ...
        $cms .= "<div class='overflow m'>
                        ...
                        <ul class='fl overflow add'>
                            <li>
                                <p class='t'>{$n3}{$addlevel1}<a href='#textarea' class='fr hfnow' postid='{$id}' tel1='{$us}' tel2='{$comment['tel']}' nickname='{$nick}' commentid='{$comment['id']}'>Phản hồi</a></p>
